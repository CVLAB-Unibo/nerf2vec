...
def mapping_network_plot() -> None:
    with autocast():  # TODO: REMOVE
        ...
        while True:
            ...
            pcd_root_path = '/media/data4TB/sirocchi/nerf2vec/mapping_network/point_clouds'  # TODO: FIX THIS PATH!
